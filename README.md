...
[**Update 2023-05-15:** `gpt_discord_bot_v2.py` is our good ol' `gpt_discord_bot.py`, but with a SQLite3 database for memory storage. This bot DOES remember. The database stores 200 interactions though can be customized. GPT is set up to remember the past 4 interactions, though this can be adjusted in the code. The way the bot is set up, it'll remember the past 4 interactions, independent of who submitted the prompt and what model they used. 
